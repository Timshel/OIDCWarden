...
fn config() -> Json<Value> {
    ...
    Json(json!({
        ...
        "settings": {
            ...
            "ssoOrgExternalId": crate::CONFIG.sso_enabled() && crate::CONFIG.sso_organizations_enabled(),
            "ssoOrgGroupExternalId": crate::CONFIG.sso_enabled() && crate::CONFIG.sso_organizations_enabled() && crate::CONFIG.org_groups_enabled(),
        },
        "environment": {
          "vault": domain,
